...
function activate(context) {
    ...
    context.subscriptions.push(vscode.window.registerWebviewViewProvider("testnova.sidebar", provider));
    context.subscriptions.push(vscode.commands.registerCommand("testnova.openChat", () => {
        provider.reveal();
    }));
    context.subscriptions.push(vscode.commands.registerCommand("testnova.setApiBaseUrl", async () => {
    ...
    context.subscriptions.push(vscode.commands.registerCommand("testnova.setToken", async () => {
    ...
    context.subscriptions.push(vscode.commands.registerCommand("testnova.clearToken", async () => {
...
function getApiBaseUrl(context) {
    const fromWorkspaceState = context.workspaceState.get(BASE_URL_KEY);
    if (fromWorkspaceState && fromWorkspaceState.trim()) {
        return fromWorkspaceState.trim().replace(/\/$/, "");
    }
    const fromConfig = vscode.workspace.getConfiguration("testnova").get("apiBaseUrl");
